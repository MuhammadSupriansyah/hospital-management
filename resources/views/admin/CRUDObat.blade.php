    ...
    <nav class="navbar navbar-expand-lg bg-primary">
        <div class="container-fluid" style="font-family: Arial, Helvetica, sans-serif;">
            <a class="navbar-brand" href="{{ route('adminMenu')}}">
                <img src="{{asset('img/rshdLogo.png')}}" alt="logo" width="70" height="70">
...
<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('admin.CRUDObat.submit') }}" method="POST" enctype="multipart/form-data">
                @csrf
        ...
        <table class="table table-bordered table-striped" id="obatTable">
            ...
            <tbody>
                ...
                @else
                    ...
                    <td>
                        @if ($obat->foto)
                        <img src="{{ asset('storage/' .$obat->foto) }}" alt="Foto" style="height: 150px;">
                    @else
                        Tidak ada foto
                    @endif
                    </td>

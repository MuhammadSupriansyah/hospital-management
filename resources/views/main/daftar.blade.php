...
<div class="container mt-5 mb-5">
    <div class="text-center mb-4">
      ...
      <p>Formulir ini untuk calon siswa Sekolah Dasar Islam Terpadu AL IHSAN</p>
    </div>

    <form class="bg-white p-4 shadow rounded" enctype="multipart/form-data">
      ...
      <h5 class="mt-4">Unggah Dokumen Siswa</h5>
      <div class="row">
